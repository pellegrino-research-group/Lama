...
namespace Lama.UI
{
    public class MenuLoad
    {
        ...
        {
            alpacaMenu = new ToolStripMenuItem("Lama")
            {
                Name = "Lama",
            };
            ...
            if (!editor.MainMenuStrip.Items.ContainsKey("Lama"))
            {
                editor.MainMenuStrip.Items.Add(alpacaMenu);
            }
            else
            {
                alpacaMenu = (ToolStripMenuItem)editor.MainMenuStrip.Items["Lama"];
                lock (alpacaMenu)
                {
        ...
        private static void PopulateSub(ToolStripMenuItem menuItem)
        {
            ...
            menuItem.DropDown.Items.Add("Documentation", null, 
                (sender, e) => OpenBrowser(sender, e, "https://lama.gitbook.io/docs"));

            menuItem.DropDown.Items.Add("Examples", null, 
                (sender, e) => OpenBrowser(sender, e, "https://lama.gitbook.io/docs/examples"));
            ...
            subMenuLicense.DropDown.Items.Add("License Terms", null,
                (sender, e) => OpenBrowser(sender, e, "https://lama.gitbook.io/docs/references/license"));

            menuItem.DropDown.Items.Add(subMenuLicense);

            // Add Help
            menuItem.DropDown.Items.Add("Help", null, (sender, e) => OpenBrowser(sender, e, "https://github.com/Lama/Lama/issues/new"));
        }
        ...
        //     try
        //     {
        //         Lama.UI.LicenseManagementForm.ShowForm();
        //     }
        //     catch (Exception ex)
        //     {
